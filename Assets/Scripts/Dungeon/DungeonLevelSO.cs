...
public class DungeonLevelSO : ScriptableObject
{
    ...
    [Tooltip("Populate the list with the room templates that you want to be part of the level. You need to ensure that room templates are included for" +
        "all room node types that are specified i nthe Room Node Graphs for the level.")]
    #endregion Tooltip
    ...
    private void OnValidate()
    {
        ...
        //Loop through all room template to check that this node type has been specified
        ...
        foreach(RoomNodeGraphSO roomNodeGraphSO in roomNodeGraphList)
        {
            ...
            foreach (RoomNodeSO roomNodeSO in roomNodeGraphSO.roomNodeList)
            {
                ...
                //Corridors and entrance already been checked
